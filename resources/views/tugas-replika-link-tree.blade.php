...
<head>
    ...
    <title>Corkcicle | Instagram, Facebook, TikTok</title>

    <link rel="stylesheet" href="tugas-replika-link-tree/replika-link-tree.css"/>
</head>
<body>
    <header>
        <div class="lala-share-button"><svg width="16" height="16" viewBox="0 0 16 16"><path fill="black" stroke="black" d="M12.6661 7.33348C12.2979 7.33348 11.9994 7.63195 11.9994 8.00014C11.9994 8.36833 12.2979 8.66681 12.6661 8.66681C13.0343 8.66681 13.3328 8.36833 13.3328 8.00014C13.3328 7.63195 13.0343 7.33348 12.6661 7.33348Z"></path><path fill="black" stroke="black" d="M8.00057 7.33348C7.63238 7.33348 7.3339 7.63195 7.3339 8.00014C7.3339 8.36833 7.63238 8.66681 8.00057 8.66681C8.36876 8.66681 8.66724 8.36833 8.66724 8.00014C8.66724 7.63195 8.36876 7.33348 8.00057 7.33348Z"></path><path fill="black" stroke="black" d="M3.33333 7.33348C2.96514 7.33348 2.66667 7.63195 2.66667 8.00014C2.66667 8.36833 2.96514 8.66681 3.33333 8.66681C3.70152 8.66681 4 8.36833 4 8.00014C4 7.63195 3.70152 7.33348 3.33333 7.33348Z"></path></svg></div>
    </header>

    <div class="lala-container">
        <div class="lala-image-container">
            <img src="/tugas-replika-link-tree/img-tugas-replika-link-tree/Logo-Corkcicle.jpg" alt="Corkcicle Logo">
        </div>
        <h1>Corkcicle</h1>
        <h2>Elevate Every Sip</h2>
        <h3>Fadhila Kamila Ismail - 5026221026</h3>

        <a class="lala-tile" href="https://corkcicle.com/products/cold-cup-xl" target="_blank">
            <div class="lala-icon">
                <img src = "tugas-replika-link-tree/img-tugas-replika-link-tree/New-Cold-Cup-XL.png" width="44px" height="44px">
            </div>
            <p>Shop the new Cold Cup XL</p>
            <div class="lala-tile-share-button"><svg width="16" height="16" viewBox="0 0 16 16"><path fill="black" stroke="black" d="M12.6661 7.33348C12.2979 7.33348 11.9994 7.63195 11.9994 8.00014C11.9994 8.36833 12.2979 8.66681 12.6661 8.66681C13.0343 8.66681 13.3328 8.36833 13.3328 8.00014C13.3328 7.63195 13.0343 7.33348 12.6661 7.33348Z"></path><path fill="black" stroke="black" d="M8.00057 7.33348C7.63238 7.33348 7.3339 7.63195 7.3339 8.00014C7.3339 8.36833 7.63238 8.66681 8.00057 8.66681C8.36876 8.66681 8.66724 8.36833 8.66724 8.00014C8.66724 7.63195 8.36876 7.33348 8.00057 7.33348Z"></path><path fill="black" stroke="black" d="M3.33333 7.33348C2.96514 7.33348 2.66667 7.63195 2.66667 8.00014C2.66667 8.36833 2.96514 8.66681 3.33333 8.66681C3.70152 8.66681 4 8.36833 4 8.00014C4 7.63195 3.70152 7.33348 3.33333 7.33348Z"></path></svg></div>
        </a>
        <a class="lala-tile" href="https://corkcicle.com/pages/affiliates" target="_blank">
            <div class="lala-icon"></div>
            <p>Join our Affiliate Program</p>
            <div class="lala-tile-share-button"><svg width="16" height="16" viewBox="0 0 16 16"><path fill="black" stroke="black" d="M12.6661 7.33348C12.2979 7.33348 11.9994 7.63195 11.9994 8.00014C11.9994 8.36833 12.2979 8.66681 12.6661 8.66681C13.0343 8.66681 13.3328 8.36833 13.3328 8.00014C13.3328 7.63195 13.0343 7.33348 12.6661 7.33348Z"></path><path fill="black" stroke="black" d="M8.00057 7.33348C7.63238 7.33348 7.3339 7.63195 7.3339 8.00014C7.3339 8.36833 7.63238 8.66681 8.00057 8.66681C8.36876 8.66681 8.66724 8.36833 8.66724 8.00014C8.66724 7.63195 8.36876 7.33348 8.00057 7.33348Z"></path><path fill="black" stroke="black" d="M3.33333 7.33348C2.96514 7.33348 2.66667 7.63195 2.66667 8.00014C2.66667 8.36833 2.96514 8.66681 3.33333 8.66681C3.70152 8.66681 4 8.36833 4 8.00014C4 7.63195 3.70152 7.33348 3.33333 7.33348Z"></path></svg></div>
        </a>
        <a class="lala-tile" href="https://corkcicle.com/collections/best-sellers" target="_blank">
            <div class="lala-icon">
                <img data-testid="LinkThumbnailImage" src="https://ugc.production.linktr.ee/9bdYyVwHTnWDXzKrOVMY_corkcicle_meta_20ce19b2-e085-4f27-9b2c-87b57b0d7ab0_1200x630.jpg?io=true&amp;size=thumbnail-stack-v1" alt="" filter="" loading="lazy" crossorigin="" class="sc-iBPRYJ sc-jONnTn gLxBPj jfNdCZ" height="44px" width="44px">
            </div>
